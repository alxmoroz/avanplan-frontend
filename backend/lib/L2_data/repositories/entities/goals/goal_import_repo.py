...
from lib.L2_data.schema import GoalImportSchemaGet, GoalSchemaUpsert
...
class GoalImportRepo(EntityRepo[GoalImportSchemaGet, GoalSchemaUpsert, GoalImport, GoalModel]):
    def __init__(self):
        super().__init__(
    ...
    def schema_upd_from_entity(self, e: GoalImport) -> GoalSchemaUpsert:
