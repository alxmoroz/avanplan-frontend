...
Revision ID: dd7fc6ed6915
Revises: 
Create Date: 2022-04-29 23:50:10.776295
...
def upgrade():
    ...
    sa.Column('workspace_id', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['assignee_id'], ['persons.id'], ondelete='SET NULL'),
    ...
    sa.ForeignKeyConstraint(['priority_id'], ['taskprioritys.id'], ondelete='SET NULL'),
    sa.ForeignKeyConstraint(['remote_tracker_id'], ['remotetrackers.id'], ondelete='SET NULL'),
    sa.ForeignKeyConstraint(['status_id'], ['taskstatuss.id'], ondelete='SET NULL'),
    sa.PrimaryKeyConstraint('id')
    )
