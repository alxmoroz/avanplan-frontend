...
import '../../L1_domain/usecases/status_uc.dart';
...
import '../../L2_data/repositories/status_repo.dart';
...
import '../views/main/controllers/statuses_controller.dart';
...
StatusesController get statusesController => GetIt.I<StatusesController>();
...
StatusUC get statusUC => GetIt.I<StatusUC>();
...
void setup() {
  ...
  getIt.registerSingleton<StatusUC>(StatusUC(StatusRepo()));
  ...
  getIt.registerSingleton<StatusesController>(StatusesController());
