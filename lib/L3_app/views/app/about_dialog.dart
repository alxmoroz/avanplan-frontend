      ...
      body: ListView(
        ...
        children: [
          ...
          Row(
            ...
            children: [
              MTButton.icon(MTImage(ImageName.telegram_icon.name, width: P10, height: P10), onTap: go2Telegram),
              const SizedBox(width: P4),
              MTButton.icon(MTImage(ImageName.mail_icon.name, width: P10, height: P10), onTap: mailUs),
              const SizedBox(width: P4),
              MTButton.icon(MTImage(ImageName.vk_icon.name, width: P10, height: P10), onTap: go2VK),
              const SizedBox(width: P4),
              MTButton.icon(MTImage(ImageName.web_icon.name, width: P10, height: P10), onTap: go2Homepage),
            ],
          ),
          ...
          D5('© ${now.date.year} Moroz Team', color: f3Color, align: TextAlign.center),
          const SizedBox(height: P_2),
          D5('© ${now.date.year} ${loc.app_title}', color: f3Color, align: TextAlign.center),
