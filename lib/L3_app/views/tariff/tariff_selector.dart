...
class _TariffSelectorDialog extends StatelessWidget {
  ...
  Widget _pageButton(PageController pc, BuildContext context, {required bool left}) {
    ...
    return Container(
        ...
        child: _controller.showPageButton(left)
            ? MTButton.icon(
                ...
                onTap: () => left ? pc.previousPage(duration: ad, curve: Curves.easeInOut) : pc.nextPage(duration: ad, curve: Curves.easeInOut),
              )
            : null);
  }
