...
class TeamPane extends StatelessWidget {
  ...
  Widget _memberBuilder(BuildContext context, int index) {
    ...
    return MTListTile(
      leading: member.isActive ? member.icon(P4, borderColor: mainColor) : const PersonCircleIcon(),
      ...
      onTap: () async => await MemberViewRouter().navigate(context, args: MemberViewArgs(member, task)),
    );
  }
