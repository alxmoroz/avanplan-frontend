  ...
  Widget build(BuildContext context) {
    switch (_at) {
      ...
      case TaskActionType.localExport:
        return _tile(leading: LocalExportIcon(size: _iconSize, circled: true), title: loc.task_transfer_export_action_title);
      case TaskActionType.duplicate:
        return _tile(leading: DuplicateIcon(size: _iconSize, circled: true), title: loc.task_duplicate_action_title);
      // case TaskActionType.go2source:
      //   return _task.go2SourceTitle;
      case TaskActionType.unlink:
        return _tile(
          leading: LinkBreakIcon(size: _iconSize, circled: true),
          title: loc.task_unlink_action_title,
          color: warningColor,
        );
      case TaskActionType.delete:
        return _tile(leading: DeleteIcon(size: _iconSize, circled: true), title: loc.delete_action_title, color: dangerColor);
      default:
        return BaseText('$_at');
    }
  }
