...
import 'package:avanplan_api/src/auth/auth.dart';
...
class BasicAuthInterceptor extends AuthInterceptor {
  ...
  void onRequest(
    ...
    final metadataAuthInfo =
        getAuthInfo(options, (secure) => (secure['type'] == 'http' && secure['scheme']?.toLowerCase() == 'basic') || secure['type'] == 'basic');
