...
[**root**](WorkspacesApi.md#root) | **GET** /v1/workspaces/{ws_id}/tasks/{task_id} | Task
...
try {
    final response = api.root(taskId, wsId);
    print(response);
} catch on DioException (e) {
    print('Exception when calling WorkspacesApi->root: $e\n');
}
```
