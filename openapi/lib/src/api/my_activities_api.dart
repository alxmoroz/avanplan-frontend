...
class MyActivitiesApi {
  ...
  Future<Response<BuiltList<UActivityGet>>> activitiesV1MyActivitiesGet({ 
    required BodyActivitiesV1MyActivitiesGet bodyActivitiesV1MyActivitiesGet,
    ...
    final _path = r'/v1/my/activities';
    ...
    try {
      const _type = FullType(BodyActivitiesV1MyActivitiesGet);
      _bodyData = _serializers.serialize(bodyActivitiesV1MyActivitiesGet, specifiedType: _type);
  ...
  Future<Response<BuiltList<UActivityGet>>> registerV1MyActivitiesRegisterPost({ 
    ...
    final _path = r'/v1/my/activities/register';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
