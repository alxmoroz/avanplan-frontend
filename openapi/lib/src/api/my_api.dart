...
class MyApi {
  ...
  /// Throws [DioError] if API call or serialization fails
  Future<Response<WorkspaceGet>> createWorkspaceV1MyCreateWorkspacePost({ 
  ...
  /// Returns a [Future] containing a [Response] with a [bool] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<bool>> redeemInvitationV1MyRedeemInvitationPost({ 
    BodyRedeemInvitationV1MyRedeemInvitationPost? bodyRedeemInvitationV1MyRedeemInvitationPost,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(BodyRedeemInvitationV1MyRedeemInvitationPost);
      _bodyData = bodyRedeemInvitationV1MyRedeemInvitationPost == null ? null : _serializers.serialize(bodyRedeemInvitationV1MyRedeemInvitationPost, specifiedType: _type);
  ...
  Future<Response<User>> updateAccountV1MyAccountPost({ 
    ...
    try {
      const _type = FullType(BodyUpdateAccountV1MyAccountPost);
  ...
  Future<Response<bool>> updatePushTokenV1MyPushTokenPost({ 
    ...
    try {
      const _type = FullType(BodyUpdatePushTokenV1MyPushTokenPost);
      _bodyData = _serializers.serialize(bodyUpdatePushTokenV1MyPushTokenPost, specifiedType: _type);
  ...
  /// Returns a [Future] containing a [Response] with a [WorkspaceGet] as data
  /// Throws [DioError] if API call or serialization fails
  Future<Response<WorkspaceGet>> updateWorkspaceV1MyUpdateWorkspacePost({ 
    required int wsId,
