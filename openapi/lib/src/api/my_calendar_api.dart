...
class MyCalendarApi {
  ...
  Future<Response<BuiltList<CalendarSourceGet>>> myCalendarSources({ 
    ...
    final _path = r'/v1/my/calendar/sources';
    ...
    BuiltList<CalendarSourceGet>? _responseData;
    ...
    return Response<BuiltList<CalendarSourceGet>>(
      data: _responseData,
  ...
  Future<Response<CalendarSourceGet>> myCalendarSourcesUpsert({ 
    ...
    CalendarSourceGet? _responseData;
    ...
    return Response<CalendarSourceGet>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<CalendarsEvents>> myCalendarsEvents({ 
    ...
    final _path = r'/v1/my/calendar/calendars_events';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    return Response<CalendarsEvents>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
