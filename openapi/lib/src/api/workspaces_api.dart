...
class WorkspacesApi {
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<InvoiceGet>> signContract({ 
    required int wsId,
    ...
    final _path = r'/v1/workspaces/{ws_id}/contracts'.replaceAll('{' r'ws_id' '}', encodeQueryParameter(_serializers, wsId, const FullType(int)).toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [InvoiceGet] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<InvoiceGet>> signOption({ 
    required int wsId,
    ...
    final _path = r'/v1/workspaces/{ws_id}/contracts/options/{option_id}'.replaceAll('{' r'ws_id' '}', encodeQueryParameter(_serializers, wsId, const FullType(int)).toString()).replaceAll('{' r'option_id' '}', encodeQueryParameter(_serializers, optionId, const FullType(int)).toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
