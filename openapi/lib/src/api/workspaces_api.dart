...
class WorkspacesApi {
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<TasksChanges>> copyTask({ 
    required int wsId,
    required int taskId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    ...
    final _path = r'/v1/workspaces/{ws_id}/tasks/{task_id}/copy'.replaceAll('{' r'ws_id' '}', encodeQueryParameter(_serializers, wsId, const FullType(int)).toString()).replaceAll('{' r'task_id' '}', encodeQueryParameter(_serializers, taskId, const FullType(int)).toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
