...
import 'package:openapi/src/model/task_relation_upsert.dart';
...
class WorkspacesApi {
  ...
  /// Returns a [Future] containing a [Response] with a [BuiltList<TaskGet>] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BuiltList<TaskGet>>> tasksList({ 
    required int wsId,
    required BuiltList<int> requestBody,
    int? taskId,
    CancelToken? cancelToken,
  ...
  Future<Response<TaskRelationGet>> upsertRelation({ 
    ...
    return Response<TaskRelationGet>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
